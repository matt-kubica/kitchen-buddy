...
const blankIngredient : Ingredient = {
  id: 0, name: '', brand: null, category: null, placement: null, confection: null,
  expirationDate: null, ripenessStatus: null, open: false, frozen: false, barcode: null
}

export const MainInputScreen = () => {
  const { addIngredient, ingredients } = useContext(AppContext);
  const [ innerIngredient, setInnerIngredient ] = useState<Ingredient>(blankIngredient);
